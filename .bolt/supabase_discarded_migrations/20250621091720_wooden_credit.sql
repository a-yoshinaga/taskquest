/*
  # Complete TaskQuest Database Schema

  1. New Tables
    - `tasks` - User tasks with gamification features
      - `id` (text, primary key)
      ...
      - `recurring_interval` (integer, optional)
      - `last_completed_date` (timestamptz, optional)
      - `next_due_date` (timestamptz, optional)
      - `total_repetitions` (integer, optional)
    ...
    - `game_stats` - User game statistics and progress
      ...
      - `last_completed_date` (date, optional)
